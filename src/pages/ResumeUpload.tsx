      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-700 via-blue-700 to-teal-600 mb-2">
            {uploadSuccess ? "Téléchargement réussi" : linkedinSuccess ? "Profil LinkedIn analysé" : "Créer un candidat"}
          </h1>
        </div>
        
        {/* Affichage conditionnel selon l'état */}
        {uploadSuccess || linkedinSuccess ? (
          <div className="relative rounded-xl overflow-hidden p-8 text-center animate-fade-in">
            ...
            <div className="relative z-10">
              <div className="relative w-20 h-20 mx-auto bg-gradient-to-br from-green-500 to-teal-600 rounded-full flex items-center justify-center mb-6 shadow-lg">
                {linkedinSuccess ? <User size={32} className="text-white" /> : <Check size={32} className="text-white" />}
              ...
              <h2 className="text-xl font-bold mb-3 text-navy-dark">
                {linkedinSuccess 
                  ? "Profil LinkedIn analysé avec succès" 
              ...
              <p className="text-muted-foreground mb-6">
                {linkedinSuccess 
                  ? "Le candidat a été créé à partir du profil LinkedIn" 
              ...
              <div className="flex justify-center gap-4">
                <Button variant="outline" onClick={handleResetUpload} className="border-navy/20 hover:border-navy/40 text-navy hover:bg-navy/5 transition-all duration-300">
                  {linkedinSuccess ? "Créer un autre candidat" : "Télécharger d'autres CV"}
                </Button>
                
                {linkedinSuccess && candidateId ? (
                  <Button 
                    onClick={() => navigate(`/candidates/${candidateId}`)}
                    className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-md transition-all duration-300 hover:shadow-lg border-0"
                  >
                    Voir le candidat
                  </Button>
                ) : (
          ...
          <div className="relative rounded-xl overflow-hidden animate-fade-in">
            ...
            <div className="relative z-10">
              <UploadForm 
                ...
                onLinkedInComplete={handleLinkedInComplete}
              />
            </div>
          </div>
        )}
