...
-- Add missing columns to ai_candidate_scores table for comprehensive AI analysis
...
DROP FUNCTION IF EXISTS public.save_ai_candidate_score(UUID, INTEGER, TEXT, UUID, JSONB);
DROP FUNCTION IF EXISTS public.get_ai_candidate_score(UUID, UUID);

-- Create the save_ai_candidate_score function with new parameters
...
-- Create the get_ai_candidate_score function to return the new fields
