...
-- Corriger la fonction RPC pour inclure explicitement les champs d'adresse
DROP FUNCTION IF EXISTS public.get_candidate_by_id_bypassing_rls;
...
BEGIN
  ...
  -- If authorized, return the candidate data with ALL fields including address fields
  RETURN QUERY
  SELECT 
    c.id,
    c.user_id,
