...
Deno.serve(async (req) => {
  ...
  try {
    console.log('Updating Claire Laurent admin status...')
    ...
    // Mettre à jour le profil pour définir is_admin à true
    ...
    console.log('Successfully updated Claire Laurent admin status')

    return new Response(
      JSON.stringify({ 
        success: true, 
        message: 'Claire Laurent est maintenant administratrice',
